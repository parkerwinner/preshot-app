...
const features = [
  {
    ...
    description: "Get personalized assessments of your readiness for top fellowships and scholarships worldwide.",
  },
  {
    icon: Target,
    title: "Real-Time Coaching",
    description: "Receive instant feedback and guidance from our AI coach tailored to your goals.",
  },
  {
    icon: Globe2,
    title: "Global Opportunity Matching",
    description: "Discover fellowships, scholarships, and programs that perfectly match your profile.",
  },
  {
    icon: Rocket,
    title: "Career Acceleration",
    description: "Fast-track your professional journey with strategic insights and action plans.",
  },
  {
    icon: Shield,
    title: "Blockchain Credentials",
    description: "Verify and showcase your achievements with tamper-proof blockchain certificates.",
  },
  {
    icon: Users,
    title: "Global Network",
    description: "Connect with a community of ambitious talents from over 80 countries.",
  },
];
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
            Preshot combines cutting-edge AI with blockchain technology to prepare you for the world's most competitive opportunities.
          </p>
        </div>
        ...
        <div className="mt-20 grid gap-8 rounded-2xl border border-border/50 bg-card/30 p-8 backdrop-blur-sm sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { value: "10K+", label: "Talents Prepared" },
