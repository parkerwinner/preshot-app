  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center">
      <div className="relative">
        ...
        <div
          className="absolute inset-4 rounded-full border-2 border-accent/30 animate-pulse"
          style={{ animationDelay: "0.2s" }}
        />
        <div
          className="absolute inset-8 rounded-full border-2 border-primary/30 animate-pulse"
    ...
    <section className="relative min-h-screen w-full overflow-hidden bg-background">
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
          ...
          >
            AI-powered diagnostics • Real-time coaching • Fellowship &
            scholarship matching • Blockchain verified credentials
          </p>
